...
SWIFT_CLASS("_TtC15reto_calculator11AppDelegate")
...
SWIFT_CLASS("_TtC15reto_calculator14ViewController")
...
- (void)viewDidLoad;
- (IBAction)numberPressed:(UIButton * __null_unspecified)btn;
...
- (void)playSound;
- (IBAction)onClearPressed:(id __nonnull)sender;
